    ...
    <>
      <div className='container mt-2'>
        <form onSubmit={()=>onSubmit(datos)}>
            ...
            <input type="text" className='form-control' value={titulo} name='titulo' onChange={cuandoCambia}/>

            <label className='form-label mt-2'>Dependencia</label>
            <input type="text" className='form-control' value={dependencia} name='dependencia' disabled/>

            <label className='label-form mt-2'>Fecha</label>
            <input type="text" className='form-control' value={fecha} name='fecha' onChange={cuandoCambia}/>

            <label className='label-form mt-2'>Introduccion de la publicacion</label>
            <textarea className="form-control" rows="3" value={parrafo1} name='parrafo1' onChange={cuandoCambia}></textarea>

            <label className='label-form mt-2'>Desarrollo de la publicacion</label>
            <textarea className="form-control" rows="3" value={parrafo2} name='parrafo2' onChange={cuandoCambia}></textarea>

            <label className='label-form mt-2'>Conclusion de la publicacion</label>
            <textarea className="form-control" rows="3" value={parrafo3} name='parrafo3' onChange={cuandoCambia}></textarea>
            ...
            <input type="file" accept=".png, .jpg, .jpeg" multiple className='form-control'/>
